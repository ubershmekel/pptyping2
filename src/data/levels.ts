...
export const LEVELS: LevelDefinition[] = [
  ...
  { number: 3,  arc: 1, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[3] },
  { number: 4,  arc: 1, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[4] },
  // Arc 2 — The Thunder Shrine
  { number: 5,  arc: 2, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[5] },
  { number: 6,  arc: 2, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[6] },
  { number: 7,  arc: 2, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[7] },
  { number: 8,  arc: 2, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[8] },
  // Arc 3 — The Crystal Cavern
  { number: 9,  arc: 3, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[9] },
  { number: 10, arc: 3, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[10] },
  { number: 11, arc: 3, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[11] },
  { number: 12, arc: 3, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[12] },
  // Arc 4 — The Stardrift Coast
  { number: 13, arc: 4, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[13] },
  { number: 14, arc: 4, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[14] },
  { number: 15, arc: 4, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[15] },
  { number: 16, arc: 4, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[16] },
  // Arc 5 — The Apex Summit
  { number: 17, arc: 5, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[17] },
  { number: 18, arc: 5, isSpeedTest: false, isFinale: false, availableLetters: LEVEL_LETTERS[18] },
  { number: 19, arc: 5, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[19] },
  { number: 20, arc: 5, isSpeedTest: false, isFinale: true,  availableLetters: LEVEL_LETTERS[20] },
];
