...
export const CUTSCENE_STORIES: Record<Team, CutsceneStory[]> = {
  pokemon: [
    ...
    // Cutscene 1 — after Level 2, before Arc 2
    {
    ...
    // Cutscene 2 — after Level 5
    {
      title: 'DEEPER INTO THE KEYBOARD',
      artClass: 'art-pokemon-2',
      paragraphs: [
        'Five more keys cleansed. Pikachu could feel the keyboard\'s power returning — each restored letter hummed with warm electric energy.',
  ...
  mlp: [
    ...
    // Cutscene 2 — after Level 5
    {
      ...
      artClass: 'art-mlp-2',
      paragraphs: [
        'Five keys befriended. Pinkie could see the keyboard lighting up like a Hearth\'s Warming display — each restored letter sparkled with genuine warmth.',
